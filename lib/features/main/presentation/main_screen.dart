...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => getIt<HomeBloc>()..load()),
        BlocProvider(create: (_) => getIt<SearchBloc>()..load()),
        BlocProvider(create: (_) => getIt<InboxBloc>()..load()),
        BlocProvider(create: (_) => getIt<ProfileBloc>()..load()),
      ],
      child: Scaffold(
        body: IndexedStack(
          index: _index,
